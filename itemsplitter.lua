...
local function CreatePopup()
    ...
    local titleText = titleBar:CreateFontString(nil, "OVERLAY", "LWT_Heading")
    ...
    closeBtn.text = closeBtn:CreateFontString(nil, "OVERLAY", "LWT_Heading")
    ...
    local dropPlus = dropSlot:CreateFontString(nil, "OVERLAY", "LWT_Title")
    ...
    local itemName = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
    itemName:SetPoint("LEFT", dropSlot, "RIGHT", 8, 6)
    itemName:SetPoint("RIGHT", f, "RIGHT", -8, 0)
    itemName:SetJustifyH("LEFT")
    f.itemName = itemName

    local stackInfo = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
    ...
    local splitLabel = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
    ...
    inputBox:SetFontObject("LWT_Body")
    ...
    local qtyLabel = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
    ...
    local qtyHint = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
    ...
    -- Status text
    local status = f:CreateFontString(nil, "OVERLAY", "LWT_Body")
